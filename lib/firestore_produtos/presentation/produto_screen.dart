...
class _ProdutoScreenState extends State<ProdutoScreen> {
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return Container(
          ...
          child: ListView(
            children: [
              Text(labelTitle, style: Theme.of(context).textTheme.bodyLarge),
              TextFormField(
  ...
  refresh() async {
    ...
    setState(() {
      ...
      // listaProdutosPlanejados = temp.where((p) => !p.isComprado).toList();
      // listaProdutosPegos = temp.where((p) => p.isComprado).toList();
    });
  }
}
